...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        if self.cell_type == 'rnn':
            h, cache_rnn = rnn_forward(embed, h0, Wx, Wh, b)  # [N, T, H]
        elif self.cell_type =='lstm':
            h, cache_lstm = lstm_forward(embed, h0, Wx, Wh, b)  # [N, T, H]
        else:
            raise ValueError(self.cell_type)
        scores, cache_temporal_affine = temporal_affine_forward(h, W_vocab, b_vocab)  # [N, T, W]
